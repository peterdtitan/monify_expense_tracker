...
class Monify:
  def __init__ (self, monthly = 0.0, food_drinks = 0.0 , transport = 0.0, housing = 0.0, life_entertainment = 0.0, miscellaneous = 0.0, emergency_fund = 0.0 ):
    self.available_income = 
...
class Debt_account:
  def __init__(self, debt_dictionary = {}):
